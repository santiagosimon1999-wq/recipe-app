...
-- ============================================================================
-- Purpose:
-- 1) Introduce scalable category groups and category registry.
-- 2) Introduce recipe_categories join table for many-to-many assignment.
-- 3) Seed production-ready category groups and categories.
--
-- Backward compatibility:
-- - Existing recipes.category (text) is preserved.
-- - New relation is additive and safe to roll out incrementally.
